...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">dynamic</span><span class="token punctuation">:</span>
    <span class="token key atrule">tp</span><span class="token punctuation">:</span>
      ...
      <span class="token key atrule">apollo</span><span class="token punctuation">:</span>                                     <span class="token comment"># 存放该线程池配置的 namespace，不配置默认拿apollo配置第一个namespace，动态调参会用到该配置项</span>
        <span class="token key atrule">namespace</span><span class="token punctuation">:</span> user<span class="token punctuation">-</span>center<span class="token punctuation">-</span>dtp<span class="token punctuation">-</span>dev.yml
      <span class="token key atrule">configType</span><span class="token punctuation">:</span> yml                             <span class="token comment"># 配置文件类型</span>
