...
<ol>
<li>
<p>动态线程池配置文件，建议单独开一个文件放到 consul 中，如：user-center-dtp</p>
</li>
<li>
...
<h4 id="yaml-格式" tabindex="-1"><a class="header-anchor" href="#yaml-格式" aria-hidden="true">#</a> yaml 格式</h4>
  ...
  <span class="token key atrule">cloud</span><span class="token punctuation">:</span>
    <span class="token key atrule">consul</span><span class="token punctuation">:</span>
      ...
      <span class="token key atrule">config</span><span class="token punctuation">:</span>
        ...
        <span class="token key atrule">format</span><span class="token punctuation">:</span> yml
        <span class="token key atrule">data-key</span><span class="token punctuation">:</span> user<span class="token punctuation">-</span>center<span class="token punctuation">-</span>dtp
