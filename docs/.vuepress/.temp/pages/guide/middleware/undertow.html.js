export const data = {
  ...
  "frontmatter": {
    ...
    "sticky": true,
    "star": true,
    "summary": "使用步骤 1. 引入下述依赖 2. 配置文件中配置 undertow 线程池 3. 启动日志 服务启动看到有如下日志输出说明接入成功，如果开启了通知，同时会推送参数修改通知\r1. 线程池名称：undertowTp 2. undertow 线程池目前只享有动态调参和监控功能，没通知报警功能 3. undertow 内部使用 xnio 网络框架，类似 netty",
    "head": [
      [
        "meta",
        {
