export const data = {
  ...
  "frontmatter": {
    ...
    "summary": "🔐 杜绝删库跑路。一个平台登录所有资产，实现事先防范、事中控制、事后溯源，满足等保合规要求。广告 功能特性 ✅ 代码零侵入：我们改变了线程池以往的使用姿势，所有配置均放在配置中心，服务启动时会从配置中心拉取配置生成线程池对象放到 Spring 容器中，使用时直接从 Spring 容器中获取，对业务代码零侵入; 通知告警：提供多种报警维度（配置变更通知、活性",
    "head": [
      [
        "meta",
        {
