  ...
  <Sidebar>
    <template #top>
      <div id="sidebar-slot-top" style="padding: 1rem 0;width:100%;margin:0 auto;display:flex;flex-direction: column;">
        <a style="margin: 0px auto; width: 100%;" href="https://easysearch.cn" target="_blank" data-date="2025-03-29">
          <img className="no-zoom" height="60" style="width: 100%; " src="/images/sponsor/easysearch-sider.webp">
        </a>
