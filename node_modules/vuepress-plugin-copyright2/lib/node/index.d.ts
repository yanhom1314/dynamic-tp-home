...
import { ConvertLocaleConfig, BasePageFrontMatter } from 'vuepress-shared';
...
declare type CopyrightLocaleConfig = ConvertLocaleConfig<CopyrightLocaleData>;
...
interface CopyrightPluginFrontmatter extends BasePageFrontMatter {
    copy?: Pick<CopyrightOptions, "triggerWords" | "disableCopy" | "disableSelection"> | boolean;
}

declare const copyrightPlugin: (options: CopyrightOptions) => PluginFunction;

export { CopyrightLocaleConfig, CopyrightLocaleData, CopyrightOptions, CopyrightPluginFrontmatter, copyrightPlugin, copyrightPlugin as default };
