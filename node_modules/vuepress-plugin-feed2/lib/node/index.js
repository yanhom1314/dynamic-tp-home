import{colors as f,fs as v,getDirname as tt,path as C}from"@vuepress/utils";import{fromEntries as P,entries as S,encodeXMLContent as M,encodeCDATA as et,isArray as _,isPlainObject as j,Logger as at,isLinkHttp as F,removeEndingSlash as E,removeLeadingSlash as D,isUrl as L,isAbsoluteUrl as I,HTML_TAGS as it,SVG_TAGS as st,MATHML_TAGS as nt,isFunction as h,getPageText as rt,getAuthor as H,getCategory as ot,getPageExcerpt as lt,ensureEndingSlash as pt,values as ut,keys as J,deepAssign as ct,checkVersion as mt}from"vuepress-shared/node";import{js2xml as K}from"xml-js";import{load as ht}from"cheerio";const R=e=>P(S(e).map(([t,a])=>t==="_attributes"&&a?[t,P(S(a).map(([i,n])=>[i,n?M(n.toString()):void 0]))]:t==="_text"?[t,M(a.toString())]:t==="_cdata"?[t,et(a)]:t==="_comment"||t==="_instruction"?[t,a]:_(a)?[t,a.map(i=>R(i))]:j(a)?[t,R(a)]:[t,M(String(a))])),U="vuepress-plugin-feed2",x=new at(U),q=(e,t)=>!e||!(e instanceof Date)?1:!t||!(t instanceof Date)?-1:t.getTime()-e.getTime(),c=(e,t="",a="")=>`${F(e)?E(e):`https://${E(e)}`}${t}${D(a)}`,dt=(e="")=>`image/${e==="jpg"?"jpeg":e==="svg"?"svg+xml":e==="jpeg"||e==="png"||e==="bmp"||e==="gif"||e==="webp"?e:""}`,V=({options:e,deprecatedOption:t,newOption:a,msg:i="",scope:n=""})=>{if(t in e){if(x.warn(`${f.magenta(t)} is ${f.yellow("deprecated")}${n?` in ${n}`:""}, please use "${f.magenta(a)}" instead.${i?`
