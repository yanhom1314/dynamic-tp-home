...
type PhotoSwipeLocaleConfig = RequiredLocaleConfig<PhotoSwipeLocaleData>;

type SupportedPhotoSwipeOptions = Exclude<PhotoSwipeOptions$1, "dataSource" | "index" | "appendToEl" | "getViewportSizeFn" | "getClickedIndexFn" | "paddingFn" | "openPromise" | "pswpModule">;

declare const photoSwipeLocales: PhotoSwipeLocaleConfig;
...
interface PhotoSwipeOptions {
     ...
     */
    options?: SupportedPhotoSwipeOptions;
    /**
     * Locale config
     *
     * 国际化配置
...
declare const photoSwipePlugin: (options?: PhotoSwipeOptions) => PluginFunction;

export { PhotoSwipeLocaleConfig, PhotoSwipeLocaleData, PhotoSwipeOptions, SupportedPhotoSwipeOptions, photoSwipeLocales, photoSwipePlugin };
