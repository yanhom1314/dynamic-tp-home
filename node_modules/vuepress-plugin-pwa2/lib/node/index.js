...
`)},U=(e={},a=!0)=>n=>{a&&B(e),P(n,k,"2.0.0-beta.63"),n.env.isDebug&&m.info("Options:",e);const{base:s,shouldPrefetch:l=!0}=n.options;e.appendBase&&F(s,e),l===!0&&m.warn('The plugin will register service worker to handle assets, so we recommend you to set "shouldPrefetch: false" in VuePress config file.');const p=W(n,e);return n.options.head=K(e,s,n.options.head),y(n,{id:"hope"}),{name:k,define:()=>({PWA_LOCALES:T({app:n,name:k,default:w,config:e.locales}),SW_FORCE_UPDATE:e.update==="force",SW_PATH:e.swPath||"service-worker.js"}),extendsBundlerOptions:(i,t)=>{A(i,t,["mitt","register-service-worker"]),O(i,t,{path:"/manifest.webmanifest",response:async(r,o)=>(o.setHeader("Content-Type","application/manifest+json"),JSON.stringify(await p)),errMsg:"Unexpected manifest generate error"})},onGenerated:async i=>{await L(i,p),await H(i,e)},clientConfigFile:i=>_(i,e)}};export{w as pwaLocales,U as pwaPlugin};
