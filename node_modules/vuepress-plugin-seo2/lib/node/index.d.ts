import { PageFrontmatter, Page, App, HeadConfig, PluginFunction } from '@vuepress/core';
...
type ExtendPage<ExtraPageData extends Record<string | number | symbol, unknown> & {
    autoDesc?: true;
    excerpt?: string;
    git?: GitData;
} = {
    ...
    excerpt?: string;
    git?: GitData;
}, ExtraPageFrontmatter extends PageFrontmatter<SEOPluginFrontmatter> = PageFrontmatter<SEOPluginFrontmatter>, ExtraPageFields extends Record<string | number | symbol, unknown> = Record<never, never>> = Page<ExtraPageData, ExtraPageFrontmatter, ExtraPageFields>;
=======
interface SeoPluginPageData extends Record<string | number | symbol, unknown> {
    autoDesc?: true;
    excerpt?: string;
    git?: GitData;
}
type ExtendPage<ExtraPageData extends Record<string | number | symbol, unknown> & Partial<SeoPluginPageData> = SeoPluginPageData, ExtraPageFrontmatter extends PageFrontmatter<SEOPluginFrontmatter> = PageFrontmatter<SEOPluginFrontmatter>, ExtraPageFields extends Record<string | number | symbol, unknown> = Record<never, never>> = Page<ExtraPageData, ExtraPageFrontmatter, ExtraPageFields>;
...
interface SeoOptions {
     ...
     * 页面是否是文章
     */
    isArticle?: <ExtraPageData extends Record<string | number | symbol, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string | number | symbol, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string | number | symbol, unknown> = Record<never, never>>(page: ExtendPage<ExtraPageData, ExtraPageFrontmatter, ExtraPageFields>) => boolean;
    /**
     * Custom OGP Generator
     *
     * 自定义 OGP 生成器
     */
    ogp?: <ExtraPageData extends Record<string | number | symbol, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string | number | symbol, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string | number | symbol, unknown> = Record<never, never>>(
    /**
     ...
     * 自定义 JSON-LD 生成器
     */
    jsonLd?: <ExtraPageData extends Record<string | number | symbol, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string | number | symbol, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string | number | symbol, unknown> = Record<never, never>>(
    /**
     ...
     * 自定义 Head 标签
     */
    customHead?: <ExtraPageData extends Record<string | number | symbol, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string | number | symbol, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string | number | symbol, unknown> = Record<never, never>>(
    /**
     * Head tag config
     *
     * head 标签配置
     ...
     * 添加首选地址
     */
    canonical?: string | (<ExtraPageData extends Record<string | number | symbol, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string | number | symbol, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string | number | symbol, unknown> = Record<never, never>>(page: ExtendPage<ExtraPageData, ExtraPageFrontmatter, ExtraPageFields>) => string | null);
}

declare const seoPlugin: (options: SeoOptions, legacy?: boolean) => PluginFunction;

export { ArticleSchema, ArticleSeoContent, BaseSeoContent, BlogPostingSchema, CreativeWorkSchema, ExtendPage, ExtendedSeoContent, FacebookSeoContent, PersonSchema, SEOPluginFrontmatter, SeoContent, SeoOptions, SeoPluginPageData, SimpleSeoContent, TwitterSeoContent, WebPageSchema, seoPlugin };
