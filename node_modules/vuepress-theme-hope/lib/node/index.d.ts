...
interface ThemeBlogHomePageFrontmatter extends ThemePageFrontmatter {
    home: true;
    layout: "BlogHome";
    /**
     * @default true
...
interface ThemeProjectHomeFeatureItemOptions {
    /**
     * Feature name
     *
     * 功能名称
...
interface ThemeProjectHomePageFrontmatter extends ThemePageFrontmatter {
    home: true;
    heroImage?: string;
    heroImageDark?: string;
    heroAlt?: string;
    ...
    features?: ThemeProjectHomeFeatureItemOptions[] | ThemeProjectHomeFeatureOptions[];
}
...
type LayoutConfig = Pick<LayoutOptions, "mobileBreakPoint" | "pcBreakPoint">;
...
interface ThemeData extends AppearanceConfig, FeatureConfig, InfoOptions, LayoutConfig {
 ...
 * @private
 */
declare const prepareBundleConfigFile: (app: App, { enableBlog, enableEncrypt, enableSlide }: ThemeStatus) => Promise<string>;

/**
 * @private
 */
declare const prepareSeparatedConfigFile: (app: App, { enableBlog, enableEncrypt, enableSlide }: ThemeStatus) => Promise<string>;
